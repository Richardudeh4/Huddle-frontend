...
const Challenges: React.FC = () => {
  return (
    <section className="border-l-[1px] border-slate-300  py-8 px-6 md:px-4 sm:px-2">
      <div className="bg-[#F2F2F2] flex rounded-md justify-between items-center px-3 py-2">
        <h1 className="font-bold text-2xl text-semiBlack tracking-wider">Daily Challenges</h1>
      ...
      <div className="relative bg-white custom-shadow challengesHolder rounded-lg p-3 mt-8 space-y-3">
